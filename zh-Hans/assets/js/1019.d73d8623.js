"use strict";(self.webpackChunkdocumentation=self.webpackChunkdocumentation||[]).push([["1019"],{1014(e,t,a){a.d(t,{diagram:()=>D});var i=a(8330),l=a(7999),r=a(1680),n=a(2487),o=a(9617),s=a(559),c=a(1049),d=a(332),p=n.UI.pie,h={sections:new Map,showData:!1,config:p},g=h.sections,u=h.showData,f=structuredClone(p),m=(0,s.K)(()=>structuredClone(f),"getConfig"),$=(0,s.K)(()=>{g=new Map,u=h.showData,(0,n.IU)()},"clear"),x=(0,s.K)(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,t),o.R.debug(`added new section: ${e}, with value: ${t}`))},"addSection"),w=(0,s.K)(()=>g,"getSections"),S=(0,s.K)(e=>{u=e},"setShowData"),y=(0,s.K)(()=>u,"getShowData"),b={getConfig:m,clear:$,setDiagramTitle:n.ke,getDiagramTitle:n.ab,setAccTitle:n.SV,getAccTitle:n.iN,setAccDescription:n.EI,getAccDescription:n.m7,addSection:x,getSections:w,setShowData:S,getShowData:y},k=(0,s.K)((e,t)=>{(0,i.S)(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},"populateDb"),C={parse:(0,s.K)(async e=>{let t=await (0,c.qg)("pie",e);o.R.debug(t),k(t,b)},"parse")},v=(0,s.K)(e=>`
  .pieCircle{
